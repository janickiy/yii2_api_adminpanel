...
awk -v ip=$IP -f /app/vagrant/provision/provision.awk /app/backend/config/main.php
...
mysql <<< 'CREATE DATABASE yii2_api_adminpanel'
mysql <<< 'CREATE DATABASE yii2_api_adminpanel_test'
echo "Done!"
